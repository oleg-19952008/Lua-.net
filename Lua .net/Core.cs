...
namespace Lua_net_ex_
{
    class Core
    {
        ...
        */
        ...
        public const string VERSION = "Lua interpeter v0.1.3.2 based on core Lua 5.2 and used NLua lib\n";
        ...
        public void RunAsAdmin()
        {
            ...
            run.FileName = Environment.CurrentDirectory + "\\Lua .net ex.exe";         
            run.Verb = "runas";
            var p = Process.Start(run);
            Environment.Exit(0);
        }
